...
<div class="container">
    <div class="loginbox">
        ...
        <a style="font-size: 24px;">登录</a>&nbsp;&nbsp;<a href="register.jsp" style="font-size: 24px;">注册</a>
            ...
            <form action="user.do?flag=1" method="post" onsubmit="return check()">
                ...
                <div class="form-group validation-code">
                    <div class="field field-icon-right">
                        ...
                        <img id="safecodeImg" src="safecode" style="height: 44px; width: 150px; float: right; border-radius: 4px;" />
                    </div>
                </div>
